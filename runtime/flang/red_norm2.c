...
// AOCC begin
void F90_I8(stride_1_norm2_real16) (__POINT_T *src_pointer, __INT_T *size, __REAL16_T *result) {
    F90_I8(norm2_real16) (src_pointer, size, result);
}
// AOCC end
...
void ENTFTN(NORM2_NODIM, norm2_nodim) (__POINT_T *result, __POINT_T *src, __INT4_T * pfr, _DIST_TYPE *result_kind, F90_Desc *src_desc) {
  ...
  // AOCC begin
  } else if (src_desc->kind == __REAL16) {
    switch(src_desc->rank) {
      case 1:
        F90_NORM2(nodim_1_real16) (result, src, src_desc);
        break;
      case 2:
        F90_NORM2(nodim_2_real16) (result, src, src_desc);
        break;
      case 3:
        F90_NORM2(nodim_3_real16) (result, src, src_desc);
        break;
      case 4:
        F90_NORM2(nodim_4_real16) (result, src, src_desc);
        break;
      case 5:
        F90_NORM2(nodim_5_real16) (result, src, src_desc);
        break;
      case 6:
        F90_NORM2(nodim_6_real16) (result, src, src_desc);
        break;
      case 7:
        F90_NORM2(nodim_7_real16) (result, src, src_desc);
        break;
      default:
        sprintf(error_msg, "Rank : %d, can not be less than 1 or greater 7\n", src_desc->rank);
        __fort_abort(error_msg);
  ...
  // AOCC begin
    ...
    switch (src_desc->rank) {
      case 1:
        ...
        break;
      case 2:
        F90_NORM2(dim_2_real16) (result, src, dim, result_desc, src_desc);
        break;
      case 3:
        F90_NORM2(dim_3_real16) (result, src, dim, result_desc, src_desc);
        break;
      case 4:
        F90_NORM2(dim_4_real16) (result, src, dim, result_desc, src_desc);
        break;
      case 5:
        F90_NORM2(dim_5_real16) (result, src, dim, result_desc, src_desc);
        break;
      case 6:
        F90_NORM2(dim_6_real16) (result, src, dim, result_desc, src_desc);
        break;
      case 7:
        F90_NORM2(dim_7_real16) (result, src, dim, result_desc, src_desc);
        break;
      default:
        sprintf(error_msg, "Rank : %d, can not be less than 1 or greater 7\n", src_desc->rank);
        __fort_abort(error_msg);
