...
! 
  ...
  integer  :: ta, tb
  complex*32   :: temp, temp0, temp1, temp2, temp3 
...
!  complex*32, dimension( bufrows * bufcols ) :: buffera, bufferb
    complex*32, allocatable, dimension(:) :: buffera, bufferb
...
#undef QCMPLX
#define QCMPLX(r,i) cmplx(r,i,kind=32)
