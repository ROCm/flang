...
void ENTF90(MMUL_cmplx32,
            mmul_cmplx32)(int ta, int tb, __POINT_T mra, __POINT_T ncb,
                          __POINT_T kab, __float128 *alpha,
                          __float128 a[], __POINT_T lda, __float128 b[],
                          __POINT_T ldb, __float128 *beta,
                          __float128 c[], __POINT_T ldc)
{
  /*
   *   Notes on parameters
  ...
  int tindex = 0;
  __float128  buffera[SMALL_ROWSA * SMALL_ROWSB];
  __float128 bufferb[SMALL_COLSB * SMALL_ROWSB];
  __float128 temp;
  void ftn_mvmul_cmplx32_(), ftn_vmmul_cmplx32_();
  void ftn_mnaxnb_cmplx32_(), ftn_mnaxtb_cmplx32_();
  void ftn_mtaxnb_cmplx32_(), ftn_mtaxtb_cmplx32_();
  __float128 calpha, cbeta;
  /*
  ...
  if ((tb != 1) && (ncb == 1)) {
    ...
    ftn_mvmul_cmplx32_(&ta, &tb, &mra, &kab, alpha, a, &lda, b, beta, c);
    return;
  }
  if ((ta != 1) && (mra == 1)) {
    /* vector matrix multiply */
    ftn_vmmul_cmplx32_(&ta, &tb, &ncb, &kab, alpha, a, b, &ldb, beta, c);
    return;
  }
  ...
  if ((colsb <= SMALL_COLSB) && (rowsa <= SMALL_ROWSA) &&
    ...
    switch (tindex) {
    case 0:
      ftn_mnaxnb_cmplx32_(&mra, &ncb, &kab, alpha, a, &lda, b, &ldb,
                            beta, c, &ldc);
      break;
    case 1:
      ftn_mtaxnb_cmplx32_(&mra, &ncb, &kab, alpha, a, &lda, b, &ldb,
                            beta, c, &ldc);
      break;
    case 2:
      ftn_mnaxtb_cmplx32_(&mra, &ncb, &kab, alpha, a, &lda, b, &ldb,
                            beta, c, &ldc);
      break;
    case 3:
      ftn_mtaxtb_cmplx32_(&mra, &ncb, &kab, alpha, a, &lda, b, &ldb,
                            beta, c, &ldc);
    }
  }
