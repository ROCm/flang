...
; GFX9-DAG: s_cselect_b32 s1, s1, 0
...
; CI-DAG: v_cmp_ne_u64_e64 s[2:3], s[[[PTR_LO]]:[[PTR_HI]]], 0{{$}}
...
; GFX9-DAG: s_cselect_b32 s[[PTR_LO]], s[[PTR_LO]], -1
; GFX9-DAG: v_mov_b32_e32 [[CASTPTR:v[0-9]+]], s[[PTR_LO]]
; HSA: buffer_store_dword v[[K]], v1, s{{\[[0-9]+:[0-9]+\]}}, 0 offen{{$}}
