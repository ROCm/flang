...
define void @f(i32 %arg, float* %ptr, <2 x i32> addrspace(4)* %arr) {
; ISA-LABEL: f:
; ISA:       ; %bb.0: ; %bb
; ISA-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; ISA-NEXT:    s_waitcnt_vscnt null, 0x0
; ISA-NEXT:    global_load_dwordx2 v[3:4], v[3:4], off
; ISA-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 1, v0
; ISA-NEXT:    v_mov_b32_e32 v7, 0
; ISA-NEXT:    s_waitcnt vmcnt(0)
; ISA-NEXT:    v_lshrrev_b32_e32 v5, 1, v4
; ISA-NEXT:    v_cmp_ne_u32_e64 s4, 0, v3
; ISA-NEXT:    v_lshrrev_b32_e64 v6, v3, 1
; ISA-NEXT:    v_cndmask_b32_e64 v3, 0, v5, s4
; ISA-NEXT:    v_cndmask_b32_e64 v5, 0, v6, s4
; ISA-NEXT:    v_cndmask_b32_e64 v4, 0, v4, s4
; ISA-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s4
; ISA-NEXT:    s_mov_b32 s4, 0
; ISA-NEXT:    v_cvt_f32_i32_e32 v6, v3
; ISA-NEXT:    v_cvt_f32_ubyte0_e32 v3, v5
; ISA-NEXT:    v_cvt_f32_i32_e32 v4, v4
; ISA-NEXT:    v_and_b32_e32 v5, 0x7fffffff, v6
...
bb:
  %i = load <2 x i32>, <2 x i32> addrspace(4)* %arr, align 4294967296
