...
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s3, s2
; GFX10PLUS-NEXT:    s_cmp_eq_u32 s8, 2
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s4, s0
; GFX10PLUS-NEXT:    s_cmp_eq_u32 s8, 3
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s5, s0
; GFX10PLUS-NEXT:    s_cmp_eq_u32 s8, 4
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s6, s0
; GFX10PLUS-NEXT:    s_cmp_eq_u32 s8, 5
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s7, s0
; GFX10PLUS-NEXT:    v_mov_b32_e32 v0, s0
; GFX10PLUS-NEXT:    ; return to shader part epilog
entry:
  %ext = extractelement <6 x float> %vec, i32 %sel
...
; GFX10PLUS:       ; %bb.0: ; %entry
; GFX10PLUS-NEXT:    s_cmp_eq_u32 s9, 1
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s3, s2
; GFX10PLUS-NEXT:    s_cmp_eq_u32 s9, 2
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s4, s0
; GFX10PLUS-NEXT:    s_cmp_eq_u32 s9, 3
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s5, s0
; GFX10PLUS-NEXT:    s_cmp_eq_u32 s9, 4
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s6, s0
; GFX10PLUS-NEXT:    s_cmp_eq_u32 s9, 5
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s7, s0
; GFX10PLUS-NEXT:    s_cmp_eq_u32 s9, 6
; GFX10PLUS-NEXT:    s_cselect_b32 s0, s8, s0
; GFX10PLUS-NEXT:    v_mov_b32_e32 v0, s0
; GFX10PLUS-NEXT:    ; return to shader part epilog
entry:
  %ext = extractelement <7 x float> %vec, i32 %sel
...
; GFX11-NEXT:     enable_sgpr_workgroup_id_z = 0
; GFX11-NEXT:     enable_sgpr_workgroup_info = 0
; GFX11-NEXT:     enable_vgpr_workitem_id = 0
...
; GFX11-NEXT:    s_cselect_b32 s3, 2.0, 1.0
; GFX11-NEXT:    s_cmp_eq_u32 s2, 2
; GFX11-NEXT:    s_cselect_b32 s3, 0x40400000, s3
