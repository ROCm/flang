...
define fastcc void @sibling_call_fastcc_multi_byval(i32 %a, [64 x i32]) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY7:%[0-9]+]]:sgpr_64(p4) = PRED_COPY $sgpr6_sgpr7
  ...
  ; GCN-NEXT:   [[PRED_COPY41:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]](p4)
...
define hidden fastcc i64 @sibling_call_i64_fastcc_i64(i64 %a) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY12:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]](p4)
...
define hidden fastcc i16 @sibling_call_i16_fastcc_i16(i16 %a) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY11:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]](p4)
...
define hidden fastcc <2 x i64> @sibling_call_v2i64_fastcc_v2i64(<2 x i64> %a) #1 {
  ...
  ; GCN-NEXT:   [[PRED_COPY14:%[0-9]+]]:_(p4) = PRED_COPY [[PRED_COPY7]](p4)
