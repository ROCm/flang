...
define amdgpu_kernel void @test_call_external_void_func_sret_struct_i8_i32_byval_struct_i8_i32(i32) #0 {
  ...
  ; GCN-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY11]], [[C3]](s64)
  ...
  ; GCN-NEXT:   [[SHL:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY17]], [[C4]](s32)
  ...
  ; GCN-NEXT:   [[SHL1:%[0-9]+]]:_(s32) = G_SHL [[PRED_COPY18]], [[C5]](s32)
