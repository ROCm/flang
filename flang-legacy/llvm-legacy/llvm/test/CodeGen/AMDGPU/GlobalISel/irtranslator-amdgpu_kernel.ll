...
define amdgpu_kernel void @i8_arg(i32 addrspace(1)* nocapture %out, i8 %in) nounwind {
  ...
  ; HSA-VI-NEXT: {{  $}}
  ; HSA-VI-NEXT:   [[PRED_COPY:%[0-9]+]]:_(p4) = PRED_COPY $sgpr4_sgpr5
  ; HSA-VI-NEXT:   [[C:%[0-9]+]]:_(s64) = G_CONSTANT i64 0
  ; HSA-VI-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY]], [[C]](s64)
  ...
  ; HSA-VI-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY]], [[C1]](s64)
  ...
  ; LEGACY-MESA-VI-NEXT: {{  $}}
  ; LEGACY-MESA-VI-NEXT:   [[PRED_COPY:%[0-9]+]]:_(p4) = PRED_COPY $sgpr0_sgpr1
  ; LEGACY-MESA-VI-NEXT:   [[C:%[0-9]+]]:_(s64) = G_CONSTANT i64 36
  ; LEGACY-MESA-VI-NEXT:   [[PTR_ADD:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY]], [[C]](s64)
  ...
  ; LEGACY-MESA-VI-NEXT:   [[PTR_ADD1:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY]], [[C1]](s64)
...
define amdgpu_kernel void @struct_argument_alignment({i32, i64} %arg0, i8 %pad, {i32, i64} %arg1) {
  ...
  ; HSA-VI-NEXT:   [[PTR_ADD2:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY]], [[C2]](s64)
  ...
  ; HSA-VI-NEXT:   [[PTR_ADD3:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY]], [[C3]](s64)
  ...
  ; HSA-VI-NEXT:   [[PTR_ADD4:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY]], [[C4]](s64)
  ...
  ; HSA-VI-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(p1) = PRED_COPY [[C5]](p1)
  ; HSA-VI-NEXT:   [[PRED_COPY2:%[0-9]+]]:_(p1) = PRED_COPY [[C5]](p1)
  ; HSA-VI-NEXT:   G_STORE [[LOAD]](s32), [[C5]](p1) :: (volatile store (s32) into `i32 addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   G_STORE [[LOAD1]](s64), [[PRED_COPY1]](p1) :: (volatile store (s64) into `i64 addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   G_STORE [[LOAD2]](s8), [[PRED_COPY2]](p1) :: (volatile store (s8) into `i8 addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   G_STORE [[LOAD3]](s32), [[C5]](p1) :: (volatile store (s32) into `i32 addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   G_STORE [[LOAD4]](s64), [[PRED_COPY1]](p1) :: (volatile store (s64) into `i64 addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   S_ENDPGM 0
  ...
  ; LEGACY-MESA-VI-NEXT:   [[PTR_ADD2:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY]], [[C2]](s64)
  ...
  ; LEGACY-MESA-VI-NEXT:   [[PTR_ADD3:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY]], [[C3]](s64)
  ...
  ; LEGACY-MESA-VI-NEXT:   [[PTR_ADD4:%[0-9]+]]:_(p4) = G_PTR_ADD [[PRED_COPY]], [[C4]](s64)
  ...
  ; LEGACY-MESA-VI-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(p1) = PRED_COPY [[C5]](p1)
  ; LEGACY-MESA-VI-NEXT:   [[PRED_COPY2:%[0-9]+]]:_(p1) = PRED_COPY [[C5]](p1)
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD]](s32), [[C5]](p1) :: (volatile store (s32) into `i32 addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD1]](s64), [[PRED_COPY1]](p1) :: (volatile store (s64) into `i64 addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD2]](s8), [[PRED_COPY2]](p1) :: (volatile store (s8) into `i8 addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD3]](s32), [[C5]](p1) :: (volatile store (s32) into `i32 addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD4]](s64), [[PRED_COPY1]](p1) :: (volatile store (s64) into `i64 addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @pointer_in_struct_argument({i8 addrspace(3)*, i8 addrspace(1)*} %arg0, i8 %pad, {i8 addrspace(3)*, i8 addrspace(1234)*} %arg1) {
  ...
  ; HSA-VI-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(p1) = PRED_COPY [[C5]](p1)
  ; HSA-VI-NEXT:   [[PRED_COPY2:%[0-9]+]]:_(p1) = PRED_COPY [[C5]](p1)
  ; HSA-VI-NEXT:   [[PRED_COPY3:%[0-9]+]]:_(p1) = PRED_COPY [[C5]](p1)
  ; HSA-VI-NEXT:   G_STORE [[LOAD]](p3), [[C5]](p1) :: (volatile store (p3) into `i8 addrspace(3)* addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   G_STORE [[LOAD1]](p1), [[PRED_COPY1]](p1) :: (volatile store (p1) into `i8 addrspace(1)* addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   G_STORE [[LOAD2]](s8), [[PRED_COPY2]](p1) :: (volatile store (s8) into `i8 addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   G_STORE [[LOAD3]](p3), [[C5]](p1) :: (volatile store (p3) into `i8 addrspace(3)* addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   G_STORE [[LOAD4]](p1234), [[PRED_COPY3]](p1) :: (volatile store (p1234) into `i8 addrspace(1234)* addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   S_ENDPGM 0
  ...
  ; LEGACY-MESA-VI-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(p1) = PRED_COPY [[C5]](p1)
  ; LEGACY-MESA-VI-NEXT:   [[PRED_COPY2:%[0-9]+]]:_(p1) = PRED_COPY [[C5]](p1)
  ; LEGACY-MESA-VI-NEXT:   [[PRED_COPY3:%[0-9]+]]:_(p1) = PRED_COPY [[C5]](p1)
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD]](p3), [[C5]](p1) :: (volatile store (p3) into `i8 addrspace(3)* addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD1]](p1), [[PRED_COPY1]](p1) :: (volatile store (p1) into `i8 addrspace(1)* addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD2]](s8), [[PRED_COPY2]](p1) :: (volatile store (s8) into `i8 addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD3]](p3), [[C5]](p1) :: (volatile store (p3) into `i8 addrspace(3)* addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD4]](p1234), [[PRED_COPY3]](p1) :: (volatile store (p1234) into `i8 addrspace(1234)* addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   S_ENDPGM 0
...
define amdgpu_kernel void @packed_struct_argument_alignment(<{i32, i64}> %arg0, i8, <{i32, i64}> %arg1) {
  ...
  ; HSA-VI-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(p1) = PRED_COPY [[C4]](p1)
  ...
  ; HSA-VI-NEXT:   G_STORE [[LOAD3]](s64), [[PRED_COPY1]](p1) :: (volatile store (s64) into `i64 addrspace(1)* null`, addrspace 1)
  ; HSA-VI-NEXT:   S_ENDPGM 0
  ...
  ; LEGACY-MESA-VI-NEXT:   [[PRED_COPY1:%[0-9]+]]:_(p1) = PRED_COPY [[C4]](p1)
  ...
  ; LEGACY-MESA-VI-NEXT:   G_STORE [[LOAD3]](s64), [[PRED_COPY1]](p1) :: (volatile store (s64) into `i64 addrspace(1)* null`, addrspace 1)
  ; LEGACY-MESA-VI-NEXT:   S_ENDPGM 0
  %val0 = extractvalue <{i32, i64}> %arg0, 0
  %val1 = extractvalue <{i32, i64}> %arg0, 1
  %val2 = extractvalue <{i32, i64}> %arg1, 0
