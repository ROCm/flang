...
; CHECK-NEXT:    s_add_i32 s18, s33, 0x100200
; CHECK-NEXT:    buffer_load_dword v0, off, s[0:3], s18 ; 4-byte Folded Reload
...
; CHECK-NEXT:    s_or_saveexec_b64 s[34:35], -1
; CHECK-NEXT:    s_add_i32 s18, s33, 0x100200
; CHECK-NEXT:    buffer_store_dword v0, off, s[0:3], s18 ; 4-byte Folded Spill
; CHECK-NEXT:    s_mov_b64 exec, s[34:35]
; CHECK-NEXT:    ;;#ASMSTART
...
; CHECK-NEXT:    v_mov_b32_e32 v1, 0x4000
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_store_dword v10, v1, s[0:3], s33 offen ; 4-byte Folded Spill
