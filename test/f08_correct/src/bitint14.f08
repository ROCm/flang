...
! Purpose: Test the operation of ATOMIC_OR intrinsic
!
PROGRAM BITINT14
  USE ISO_FORTRAN_ENV
  ...
  CALL ATOMIC_OR (A(1)[1], INT(B'10111010001'), STATUS(1))
  CALL ATOMIC_OR (A(2)[1], INT(B'10111010001'), STATUS(2))
  CALL ATOMIC_OR (A(2)[1], INT(B'10111010001'), STATUS(3))
